    ...
    <>
            {zivotInfoValue &&
                <div style={{ fontFamily: "sans-serif" }}>
                    ...
                    <p style={{ fontSize: "14.5px",textAlign:"justify" }}>Последице представљају ефекат штетног догађаја по живот и здравље људи, а изражавају се према критеријумима датим у табели.</p>
